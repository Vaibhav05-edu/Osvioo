        ...
        <div class="col-md-10">
            <div class="card border-0 shadow-sm p-4" style="border-radius: 15px;">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('osvioo-admin.stats.index') }}" class="btn btn-light btn-sm text-muted">
                        <i class="fas fa-arrow-left me-1"></i> Back to List
                    </a>
                </div>

                <form action="{{ route('osvioo-admin.stats.update', $stat->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')

    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                ...
                <div class="card-body">
                    <form action="{{ route('socialyt-admin.faq.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" name="question" class="form-control" placeholder="e.g. What is Socialyt?" required>
                            </div>
                            <div class="col-md-12 mb-3">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('socialyt-admin.faq.index') }}" class="btn btn-light px-4">Cancel</a>

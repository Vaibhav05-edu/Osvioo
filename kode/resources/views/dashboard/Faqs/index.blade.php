...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <!-- Add FAQ Button -->
        <a href="{{ route('socialyt-admin.faq.create') }}" class="btn-add">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="d-flex justify-content-end gap-2">
                                <!-- Edit Button -->
                                <a href="{{ route('socialyt-admin.faq.edit', $faq->id) }}" class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-edit"></i>
                                </a>
                                
                                <!-- Delete Button (with Form for Security) -->
                                <form action="{{ route('socialyt-admin.faq.destroy', $faq->id) }}" method="POST" onsubmit="return confirm('Are you sure?')">
                                    @csrf
                                    @method('DELETE')

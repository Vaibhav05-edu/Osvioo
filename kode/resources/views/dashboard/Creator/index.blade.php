...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('socialyt-admin.creator.create') }}" class="btn btn-dark px-4">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('socialyt-admin.creator.edit', $creator->id) }}" class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('socialyt-admin.creator.destroy', $creator->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this creator?')">
                                    @csrf
                                    @method('DELETE')

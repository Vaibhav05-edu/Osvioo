                ...
                <div class="glass-card p-5 border-0 shadow-sm" style="background: white; border-radius: 30px; box-shadow: 0 20px 60px rgba(0,0,0,0.02) !important;">
                    ...
                    <div class="content-section mb-5">
                        <p class="text-muted leading-relaxed fs-15">
                            {{ translate('Socialyt respects your privacy and is fully committed to user data control and GDPR compliance. We provide simple, instant methods for users to request and execute the deletion of all personal data, social profile tokens, posting history, and automation logs stored on our platform.') }}
                        </p>
                    </div>
                    ...
                    <div class="content-section mb-5">
                        ...
                        <div class="d-flex align-items-start gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-muted fs-14 mb-0">
                                    {{ translate('Login to your Socialyt Dashboard, navigate to') }} <strong>{{ translate('Profile Settings') }}</strong>, {{ translate('click the') }} <strong>{{ translate('Delete Account') }}</strong> {{ translate('tab, tick the confirmation checkbox, and click "Permanently Delete My Account." All data is instantly erased from our MySQL server.') }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-start gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-muted fs-14 mb-0">
                                    {{ translate('If you only want to remove Facebook/Instagram integration data without deleting your Socialyt login, go to the') }} <strong>{{ translate('Social Accounts') }}</strong> {{ translate('section, find your profile connection card, and click') }} <strong>{{ translate('Delete') }}</strong>. {{ translate('This will revoke our Meta OAuth access tokens and wipe connection logs instantly.') }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-start gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-muted fs-14 mb-0">
                                    {{ translate('If you cannot access your account dashboard, send an email to') }} <a href="mailto:support@socialyt.com" class="text-primary fw-bold">support@socialyt.com</a> {{ translate('with the subject line "Request for Data Deletion." Our support team will process your request, verify identity, and wipe all databases within 24 to 48 hours.') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="content-section mb-4">
                        ...
                        <p class="text-muted fs-15 mb-0">
                            {{ translate('This directly stops Meta webhook subscriptions and terminates connection access to Socialyt.') }}
                        </p>
                    </div>

            ...
            <div class="container-fluid px-0">
                ...
                <div class="collapse navbar-collapse" id="wishlinkNav">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-lg-4 align-items-center">
                        <li class="nav-item">
                            <a class="nav-link-wishlink active-pill" href="{{route('home')}}">Creators</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link-wishlink" href="{{route('plan')}}">Pricing</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link-wishlink" href="{{route('affiliate')}}">Affiliate</a>
                        </li>
                        <li class="nav-item">

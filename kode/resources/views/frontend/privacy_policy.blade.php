            ...
            <div class="col-lg-10">
                <div class="glass-card p-5 border-0 shadow-sm" style="background: white; border-radius: 30px; box-shadow: 0 20px 60px rgba(0,0,0,0.02) !important;">
                    ...
                    <div class="content-section mb-5">
                        ...
                        <p class="text-muted leading-relaxed fs-15">
                            {{ translate('When you authenticate your social platforms (such as Facebook or Instagram) with Socialyt, we collect and store certain data to provide our automation and posting services:') }}
                        </p>
                    ...
                    <div class="content-section mb-5">
                        ...
                        <p class="text-muted leading-relaxed fs-15">
                            {{ translate('We strictly use your information to operate and optimize the Socialyt service. Specifically, we use it to:') }}
                        </p>
                        <ul class="text-muted fs-15 ps-4" style="list-style-type: square; line-height: 1.8;">
                    ...
                    <div class="content-section mb-4">
                        ...
                        <p class="text-muted leading-relaxed fs-15">
                            {{ translate('If you have any questions or feedback regarding this Privacy Policy, please feel free to reach out to our privacy compliance officer at') }} <a href="mailto:support@socialyt.com" class="text-primary fw-bold">support@socialyt.com</a>.
                        </p>
                    </div>

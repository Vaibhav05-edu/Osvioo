...
<div class="faq-section-wrapper">
    <div class="container">
        ...
        <div class="faq-accordion-custom" id="pricingAccordion">
            @php
                $faqs = [
                    ['q' => 'How does the Socialyt Creator payout process work?', 'a' => 'Creators are paid out automatically through our secure payment gateway once they reach the minimum threshold.'],
                    ['q' => 'How does Socialyt help Creators grow?', 'a' => 'We provide AI-driven insights, content automation, and direct brand connection tools to amplify your reach.'],
                    ...
                    ['q' => 'Is my account safe with Socialyt?', 'a' => 'Yes, we use industry-standard encryption and official APIs to ensure your accounts are always secure.'],
                    ['q' => 'Can I use Socialyt for multiple accounts?', 'a' => 'Yes, depending on your plan, you can manage multiple social profiles from a single dashboard.']
                ];
            @endphp
            @foreach($faqs as $i => $f)

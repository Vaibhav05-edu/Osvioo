                    ...
                    <div class="row g-4">
                                ...
                                <div class="d-flex flex-wrap gap-3 mt-2">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="acc_{{$account->id}}">
                                            <i class="bi bi-{{strtolower($account->platform->name)}}"></i> {{$account->name}}
                                        </label>
                                    </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-inner">
                                ...
                                <input type="color" id="theme_color" name="theme_color" value="#5D5AF1" class="form-control form-control-color w-100" required>
                            </div>

...
<body>
    <div class="invoice-box">
        ...
        <div style="text-align: center; margin-top: 40px; position: relative; z-index: 1;">
            <a href="{{ route('user.invoice.download', $invoice->uid) }}" style="padding: 10px 20px; background-color: #007bff; color: white; text-decoration: none; border-radius: 5px;">Download PDF</a>
        </div>
    </div>
</body>
</html>

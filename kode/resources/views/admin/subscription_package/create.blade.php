                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="form-inner mb-0">
                                                        ...
                                                        <input type="number" min="-1"
                                                        value="{{old('social_access.auto_dm_limit', -1)}}" name="social_access[auto_dm_limit]" id="auto_dm_limit" placeholder="{{translate('Auto DM Limit')}}" required   >
                                                    </div>
                                                </div>

                                                <div class="col-xl-6">
                                                    <div class="form-inner mb-0">
                                                        <label for="media_kit_limit">
                                                            {{ translate('Media Kit Limit') }}
                                                            <small class="text-danger" >*</small>
                                                            <i data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="{{translate('Set -1 to make it unlimited')}}" class="ms-1  pointer las la-question-circle  text--danger"></i>
                                                        </label>
                                                        <input type="number" min="-1"
                                                        value="{{old('social_access.media_kit_limit', 1)}}" name="social_access[media_kit_limit]" id="media_kit_limit" placeholder="{{translate('Media Kit Limit')}}" required   >
                                                    </div>
                                                </div>

                                                <div class="col-xl-6">
                                                    <div class="form-inner mb-0">
                                                        <label for="invoice_limit">
                                                            {{ translate('Invoice Limit') }}
                                                            <small class="text-danger" >*</small>
                                                            <i data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="{{translate('Set -1 to make it unlimited')}}" class="ms-1  pointer las la-question-circle  text--danger"></i>
                                                        </label>
                                                        <input type="number" min="-1"
                                                        value="{{old('social_access.invoice_limit', -1)}}" name="social_access[invoice_limit]" id="invoice_limit" placeholder="{{translate('Invoice Limit')}}" required   >
                                                    </div>
                                                </div>

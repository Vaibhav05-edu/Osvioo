            ...
            Route::controller(UserController::class)->group(function(){
               ...
               Route::get('trial/{slug}','trialPurchase')->name('plan.trial');
                ...
                Route::prefix("/invoice")->name('invoice.')->group(function(){
                    ...
                    Route::get('/edit/{uid}', [\App\Http\Controllers\User\InvoiceController::class, 'edit'])->name('edit');
                ...
                Route::prefix("/mediakit")->name('mediakit.')->group(function(){
                    ...
                    Route::post('/ai-quick', [\App\Http\Controllers\User\MediaKitController::class, 'aiQuick'])->name('ai.quick');
                });
